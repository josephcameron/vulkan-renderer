...
const std::vector<const char *const> deviceExtensions = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};
}
...
private:
    ...
    void createTextureImageView() { textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_ASPECT_COLOR_BIT, mipLevels); }
    ...
    void createUniformBuffer()
    {
        ...
        createBuffer(
            bufferSize, VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, uniformBuffer, uniformBufferMemory);
    }
